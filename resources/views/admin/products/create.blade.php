        ...
        <div class="col-lg-8">
            <div class="card">
                <form enctype="multipart/form-data" name="add-blog-post-form" id="add-blog-post-form" method="post"
                      action="{{ route('admin.services.store') }}" style="margin: 20px">
                    @csrf
                    <div class="form-row">
                        <div class="col mb-2">
                        ...
                        <div class="col mb-3">
                            ...
                            <select class="custom-select" name="is_for_sale" required>
                                <option class="text--small badge font-weight-normal badge--success"
                                        value="Sale">@lang('Sale')</option>
                                <option class="text--small badge font-weight-normal badge--warning"
                                        value="Rent">@lang('Rent')</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="col mb-3">
                            ...
                            <textarea rows="2" type="text" name="location" class="form-control" id="validationCustom05"
                                      placeholder="@lang('Location')" value="" required></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="col mb-3 ">
                            ...
                            <select onchange="addRowCategory(this.value)" id="sections" name="section_id" value=""
                        ...
                        <div class="col mb-3">
                            ...
                            <select disabled onchange="addRowSizes(this.value)" id="categories" name="category_id"
                        ...
                        <div class="col mb-3 ">
                            ...
                            <select disabled id="sizes" name="size_id" value="" class="form-control selectpicker"
                                    data-live-search="true" required>
