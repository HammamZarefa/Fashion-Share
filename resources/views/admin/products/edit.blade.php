    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            <div class="card">
                @if ($branch)
                    @php
                        $Colors = optional($branch)->colors;
                        $Sizes = optional($branch)->sizes;
                        $Categories = optional($branch)->categories;
                        $Conditions = optional($branch)->conditions;
                        $Materials = optional($branch)->materials;
                        $Sections = optional($branch)->sections;
                        $seasons = optional($branch)->seasons;
                        $styles = optional($branch)->styles;
                    @endphp
                    <form enctype="multipart/form-data" name="add-blog-post-form" id="add-blog-post-form" method="post"
                        action="{{ route('admin.services.update', $services->id) }}" style="margin: 20px">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="images[]" id="inputImage" multiple="multiple"
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            @foreach ($services->images as $img)
                                                                <div class="col-lg-4">
                                                                    <div class="card">
                                                                        <img src="{{ getImage(imagePath()['service']['path'] . '/' . $img->path, imagePath()['service']['size']) }}"
                                                                            class="card-img-top" alt="Waterfall" />
                                                                        <div class="card-body">
                                                                            <a href="{{ url('admin/services/deleteImage/' . $img->id) }}"
                                                                                class="btn btn-danger"
                                                                                style="margin: 0px">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="col mb-3 ">
                                            ...
                                            <select onmouseup="filterCategoriesBySection(this.value)" id="sections"
                                                name="section_id" class="form-control selectpicker" data-live-search="true"
                                                required>
                                                @foreach ($Sections as $Section)
                                                    <option value="{{ $Section->id }}"
                                                        @if ($services->section_id == $Section->id) selected @endif>
                                                        {{ $Section->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select id="categories" name="category_id"
                                                onmouseup="filterSizesByCategory(this.value)"
                                                onchange="filterSizesByCategory(this.value)"
                                                class="form-control selectpicker" data-live-search="true">
                                                @foreach ($Categories as $Category)
                                                    <option value="{{ $Category->id }}"
                                                        @if ($services->category_id == $Category->id) selected @endif
                                                        @if ($Category->where('section_id', $services->section_id)->first() == null) disabled @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col mb-2">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control"
                                                id="validationCustom01" placeholder="@lang('Name')"
                                                value="{{ __($services->name) }}" required>
                                        ...
                                        <div class="col mb-3 ">
                                            ...
                                            <select id="sizes" name="size_id" value=""
                                                class="form-control selectpicker" data-live-search="true" required>
                                                @foreach ($Sizes as $Size)
                                                    <option value="{{ $Size->id }}"
                                                        @if ($services->size_id == $Size->id) selected @endif>
                                                        {{ $Size->name }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="material_id" value="" class="form-control selectpicker"
                                                ...
                                                @foreach ($Materials as $Material)
                                                    <option value="{{ $Material->id }}"
                                                        @if ($services->material_id == $Material->id) selected @endif>
                                            ...
                                            <select name="season_id" value="" class="form-control selectpicker"
                                                ...
                                                @foreach ($seasons as $season)
                                                    <option value="{{ $season->id }}"
                                                        @if ($services->season_id == $season->id) selected @endif>
                                                        {{ $season->name }}</option>
                                                @endforeach
                                            </select>
                                            {{-- <input type="text" class="form-control" id="validationCustom05" placeholder="Zip" value="" required> --}}
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select name="status" class="custom-select" required>
                                                <option value="{{ 'available' }}"
                                                    {{ $services->status == 'available' ? 'selected' : '' }}>
                                                    @lang('Available')</option>
                                                <option value="{{ 'sale' }}"
                                                    {{ $services->status == 'sale' ? 'selected' : '' }}>@lang('Sale')
                                                </option>
                                                <option value="{{ 'rent' }}"
                                                    {{ $services->status == 'rent' ? 'selected' : '' }}>@lang('Rent')
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <textarea rows="2" name="description" type="text" class="form-control" id="validationCustom02"
                                                placeholder="@lang('Description')" value="{{ $services->description }}" aria-describedby="inputGroupPrepend">{{ $services->description }}</textarea>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <select name="color_id" id="color" value=""
                                                class="form-control selectpicker" data-live-search="true" required>
                                                @foreach ($Colors as $color)
                                                    {{-- <p>{{ old('color') }}</p>; --}}
                                                    <option value="{{ $color->id }}"
                                                        @if ($services->color_id == $color->id) selected @endif>
                                                        {{ $color->name }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="condition_id" value="" class="form-control selectpicker"
                                                ...
                                                @foreach ($Conditions as $Condition)
                                                    <option value="{{ $Condition->id }}"
                                                        @if ($services->condition_id == $Condition->id) selected @endif>
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="buy_price" class="form-control"
                                                    id="validationCustomUsername" placeholder="@lang('Buy Price')"
                                                    value="{{ $services->buy_price }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="price" class="form-control"
                                                    id="validationCustomUsername" placeholder="@lang('Cost')"
                                                    value="{{ $services->price }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="sell_price" class="form-control"
                                                    id="validationCustomUsername" placeholder="@lang('Sell Price')"
                                                    value="{{ $services->sell_price }}" required>
                                                <div class="invalid-feedback">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="col mb-3">
                                            ...
                                            <input type="hidden" name="barcode" id="barcodeInput"
                                                value="{{ $services->barcode }}">
                                            <button type="button" class="btn btn-primary" id="showBarcodeBtn"
                                                onclick="showBarcode({{ $services->barcode }})">@lang('Show Barcode')</button>
                                            <button type="button" class="btn btn-primary" id="generateBarcodeBtn"
                                                onclick="generateBarcode()">@lang('Change Barcode')</button>
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-outline-primary b-radius--capsule"
                                            id="printBarcode" onclick="printBarcoderrrrr()" style="display: none;">
...
<script>
    ...
    function filterCategoriesBySection(sectionId) {
        ...
        var categories = {!! json_encode(optional($Categories)) !!};
