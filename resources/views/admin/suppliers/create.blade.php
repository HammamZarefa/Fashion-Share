...
{{--                    <a href="{{route('admin.service.createWithSupplier',[$supplier->id,'create'])}}" class="btn btn-outline-primary b-radius--capsule disabled-link" >--}}
{{--                        @lang('Add Product')--}}
{{--                    </a>--}}
                    <a href="#" class="btn btn-outline-primary b-radius--capsule disabled-link" >
                        @lang('Add Product')
                    </a>
                </div>
            </div><!-- card end -->
...
{{--                            @endforelse--}}
                ...
                <div class="card-footer" style="text-align-last:right">
                    <a href="#" class="btn btn-outline-primary b-radius--capsule addPaymentBtn disabled-link"
                       data-original-title="@lang('Add Payment')" data-toggle="tooltip"
                       data-url="#" >
                        @lang('Add Payment')
                    </a>
{{--                    <a href="javascript:void(0)" class="btn btn-outline-primary b-radius--capsule addPaymentBtn disabled-link"--}}
{{--                       data-original-title="@lang('Add Payment')" data-toggle="tooltip"--}}
