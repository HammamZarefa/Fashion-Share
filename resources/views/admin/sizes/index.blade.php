        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" style="margin: -1rem -1rem -1rem 0rem" 1
                            aria-label="Close"><span
                            aria-hidden="true">×</span></button>
                </div>
                <form class="form-horizontal" method="post" action="{{ route('admin.sizes.store')}}"
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-sm-12">
                                <select onmouseup="filterCategoriesBySection(this.value)" id="sections"
                                        name="section_id" value="" class="form-control selectpicker"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row form-group">
                            <label class="font-weight-bold ">@lang('Section') <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <select onmouseup="filterCategoriesBySectionEdit(this.value)" id="sections_edit"
                                        name="section_id" value="" class="form-control selectpicker"
                        ...
                        <div class="form-row form-group">
                            <label class="font-weight-bold ">@lang('Name') <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <select id="categories_edit" name="category_id" value=""
                                        class="form-control selectpicker" data-live-search="true">
                                    {{-- <option selected disabled>Select Section</option> --}}
                                    @if(!$sizes->isEmpty())
