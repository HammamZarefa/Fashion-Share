            ...
            <div class="">
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive b-radius--10">
                        <table class="table table--light tabstyle--two custom-data-table b-radius--10">
                            <thead>
                            <tr>
...
@push('script')
    <script>
        function discountPrice(){
            ...
            oldPriceBeforDiscount = document.getElementById('totalPriceAfterDiscount').innerHTML
